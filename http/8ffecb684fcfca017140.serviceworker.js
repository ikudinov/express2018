...
self.addEventListener('push', function (event) {
  ...
  event.waitUntil(self.clients.matchAll().then(function (clients) {
    ...
    return !appInFocus && self.registration.showNotification(message, { icon: icon, data: data });
  }, function () {
    self.registration.showNotification(message, { icon: icon, data: data });
  }));
});
...
/***/ })
/******/ ]);
//# sourceMappingURL=8ffecb684fcfca017140.serviceworker.js.map